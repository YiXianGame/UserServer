...
namespace Make
{
    public static class Core
    {
        ...
        public static UserRequest UserClient { get => userRequest; set => userRequest = value; }

        public static SkillCardRequest SkillCardClient{ get => skillCardClient; set => skillCardClient = value; }
